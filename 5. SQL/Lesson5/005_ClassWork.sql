...
(
	NAME = 'ShopDB',            
	FILENAME = 'D:\Homework\Lesson5\ShopDB.mdf', 
	SIZE = 10MB,                    
	MAXSIZE = 100MB,				
	FILEGROWTH = 10MB				
)
...
( 
	NAME = 'LogShopDB',            
	FILENAME = 'D:\Homework\Lesson5\LogShopDB.ldf', 
	SIZE = 5MB,                        
	MAXSIZE = 50MB,                    
	FILEGROWTH = 5MB                   
)   
...
SELECT Products.ProdID, [Description], SUM(Qty) AS Qty
	FROM Products
...
SELECT Products.ProdID, [Description], SUM(TotalPrice) AS TotalSold
	FROM Products
INNER JOIN OrderDetails
	ON Products.ProdID = OrderDetails.ProdID
	GROUP BY Products.ProdID, [Description]
